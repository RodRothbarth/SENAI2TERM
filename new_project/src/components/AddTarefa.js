...
const AddTarefa = ({navigation}) => {
  ...
  const createTarefa = async () => {
    ...
    if (tituloTarefa && descricaoTarefa){
      try{
        const response = await api.post('/todos', {"titulo": tituloTarefa, "descricao": descricaoTarefa, "date":dateTarefa});
    ...
    <>
      ...
      <View>
        ...
        <View style={styles.textAreaContainer} >
          ...
          />
          <DatePicker placeholder="Data" style={styles.input} date={dateTarefa} onDateChange={setdateTarefa} />
